...
<header class="top-header" role="banner">
 ...
 <h1 class="contacthead" align="center">We'd love to hear from you</h1>

   <p align="center" style="color: #7e7e7e">Do you have questions about features,need a demo or suggestions on how to help us improve, our team is ready to answer your questions</p>
    </br>
      ...
      <table >
        <tr>
          <td valign="top">
           ...
           <td valign="top"">
               <input type ="text""name="name" maxlength="50" placeholder="Name" size="25">
           </td>
        </tr>
         <td valign="top">
          ...
          <td valign="top"">
           <input type ="text""name="email" maxlength="80" placeholder="Email Address" size="25">
          </td>
         </tr>
         <tr>
          <td valign="top">
           ...
           <td valign="top">
            <textarea name="comments" maxlength="1000" cols="25" placeholder="Type here..." rows="6"></textarea>
           </td>
          </tr>
...
<div class="address">
    <p>
Address: HNG Towers</p>
     <br>
    <p>
Phone No: +234 0009998887
     <br>
     <br>
    <p>

Email :pontusdrive@gmail.com</p>
     <br>
     <hr>
