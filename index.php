    ...
    <div class="row m-0">
        <div class="col-lg-7">
            <div class="hero-heading">
                ...
                <br>
                <h4 style="color: #7e7e7e">Pontus slack drive, is built to help you store your slack messages
                    for productive collaborations. It automatically saves conversations to our drive and easy to access.</h3>
            </div>
        </div>
        <div class="col-lg-5">
            <div class="img-block">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="benefits-col" align="center">
                    ...
                    <div class="benefits-body">
                        <p style="font-size: 17px;">Pontus slack drive, makes it super easy to store all your data with just a click. It will provide you backup of all your conversations and important data on our server in record time.</p>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="benefits-col">
                    ...
                    <div class="benefits-body"  align="center">
                        <p style="font-size: 17px;">You don’t have to worry about loosing important data and conversations,
